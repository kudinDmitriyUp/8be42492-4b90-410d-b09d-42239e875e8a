...
export const metadata: Metadata = {
  title: "Elite Football Coaching | Professional Training Programs",
  description: "Professional football coaching for athletes of all levels. Personalized training, proven methods, and championship results.",
  keywords: ["football coaching", "training programs", "athlete development", "quarterback coach", "sports coaching"],
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    ...
    description: "Professional football coaching for athletes of all levels. Personalized training, proven methods, and championship results.",
    type: "website",
    siteName: "Elite Football Coaching",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764788108547-tjza8p3h.jpg",
  ...
  twitter: {
    ...
    title: "Elite Football Coaching | Professional Training Programs",
    description: "Professional football coaching for athletes of all levels. Personalized training, proven methods, and championship results.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764788108547-tjza8p3h.jpg"],
  },
};
